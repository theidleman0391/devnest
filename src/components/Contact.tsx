...
const Contact = () => {
  ...
  const waMessage =
    lang === "es"
      ? "Hola, quisiera consultar para un proyecto de página web / app"
      : "Hello, I would like to inquire about a web page / app project";
  const waUrl = `https://wa.me/522203305165?text=${encodeURIComponent(waMessage)}`;
    ...
    <section id="contact" className="py-24 px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold font-mono mb-6">{t("contact.heading")}</h2>
          <p className="text-muted-foreground mb-8 max-w-md mx-auto">{t("contact.description")}</p>

          <a
            href={waUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-foreground font-mono text-sm rounded-md hover:opacity-90 transition-opacity glow"
          >
            <WhatsAppIcon />
            {t("contact.cta")}
          </a>
